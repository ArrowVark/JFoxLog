...
import io.github.arrowvark.jfoxlog.annotation.FieldTransformation.FieldTransformation;
import io.github.arrowvark.jfoxlog.annotation.transforms.FrameTransform;
    ...
    public static void processComplexTypes(Element field, FoxgloveChannel.LoggingType loggingType, String simpleName, TypeSpec.Builder generatedClass, MethodSpec.Builder getMethod, MethodSpec.Builder setupChildObjectsBuilder) {
        ...
        if (frameTransformAnnotation != null) {
            createComplexChannelAndSetup(
                    ...
                    io.github.arrowvark.jfoxlog.foxglove.types.scene.frameTransform.FrameTransform.class,
                    "new $T(" +
                            ...
                            "io.github.arrowvark.jfoxlog.foxglove.types.geometry.vector.Vector3.kZero(), " +
                            "io.github.arrowvark.jfoxlog.foxglove.types.geometry.Quaternion.kIdentity()" +
...
//                ).build();
    ...
    public static String timestampNowFullReference() {
        return "io.github.arrowvark.jfoxlog.foxglove.types.time.Timestamp.now()";
    }
}
