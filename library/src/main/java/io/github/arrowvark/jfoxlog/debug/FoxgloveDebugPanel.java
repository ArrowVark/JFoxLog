package io.github.arrowvark.jfoxlog.debug;
...
import io.github.arrowvark.jfoxlog.foxglove.servers.websocket.FoxgloveWebSocketConnection;
...
public class FoxgloveDebugPanel {
    ...
    private static final CopyOnWriteArrayList<String> pendingLogs = new CopyOnWriteArrayList<>();
...
//        frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
    ...
    private static JComponent buildConnectionsComponent() {
        ...
        reloadConnections();
        log("Built connections component");
