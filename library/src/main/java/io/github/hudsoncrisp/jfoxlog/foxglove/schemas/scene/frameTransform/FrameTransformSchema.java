package io.github.hudsoncrisp.jfoxlog.foxglove.schemas.scene.frameTransform;

public class FrameTransformSchema {
    public static final String NAME = "foxglove.FrameTransform";
